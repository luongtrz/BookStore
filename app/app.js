...
// Khởi động server chỉ sau khi kết nối MongoDB thành công
async function startServer() {
  await connectToDatabase();  // Đảm bảo kết nối MongoDB xong trước khi khởi động server
  ...
  // // Chạy ứng dụng trên cổng mà Vercel cung cấp
